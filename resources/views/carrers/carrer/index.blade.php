            ...
            <div class="col-md-9">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <a href="{{ url('admin/carreras/create') }}" class="btn btn-success btn-sm" title="@lang('form.add')">
                            ...
                            <table class="table table-borderless">
                                ...
                                @for($i = 0; $i < count($carrer); $i++)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url('/admin/carreras/' . $carrer[$i]->id) }}" title="@lang('form.view')"><button class="btn btn-info btn-xs"><i class="fa fa-eye" aria-hidden="true"></i> <span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span></button></a>
